...
import { useGetParticipatedQuestsQuery } from "../../features/quest-engine/quest.api";
...
const ParticipatedQuests = (props: { user: any }) => {
	const { user } = props;
	const { data: quests, isLoading, isError } = useGetParticipatedQuestsQuery(user._id);
