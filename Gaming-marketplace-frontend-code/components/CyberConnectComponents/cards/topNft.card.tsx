...
const TopNFTCard = ({
	...
	return (
		<div className="flex min-h-[350px] w-[450px] min-w-[450px] flex-col items-center space-y-6 rounded-3xl border border-[#212121] bg-[#111111] p-6 duration-150 hover:scale-105 hover:bg-[#212121]">
			<div className="">
				{type === "video" ? (
					<div
			...
			<div className="flex w-full flex-grow flex-col justify-around space-y-6">
				...
				{collectMw.type !== "COLLECT_FREE" && (
					<div className="flex w-full rounded-lg bg-[#080808] p-3 px-4 font-poppins text-textMedium2 text-gray-400">
						<div className="w-full">{price} LINKS</div>
						<div className="w-full text-right text-gray-400">{remaining} Left</div>
					</div>
				)}
				<button
					type="button"
